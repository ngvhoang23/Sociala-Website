...
function MediaGrid6Item({ item1, item2, item3, item4, item5, item6, res_media_quantity }) {
  ...
  return (
    <div className={cx('six-item-wrapper')}>
      <div
        className={cx('six-item-container', 'item1', { flash: flashing.item === 1 })}
      ...
      <div
        className={cx('six-item-container', 'item2', { flash: flashing.item === 2 })}
      ...
      <div
        className={cx('six-item-container', 'item3', { flash: flashing.item === 3 })}
      ...
      <div
        className={cx('six-item-container', 'item4', { flash: flashing.item === 4 })}
      ...
      <div
        className={cx('six-item-container', 'item5', { flash: flashing.item === 5 })}
      ...
      >
        ...
        <div className={cx('res-media-quantity')}>+{res_media_quantity}</div>
      </div>
    </div>
  );
}

export default MediaGrid6Item;
