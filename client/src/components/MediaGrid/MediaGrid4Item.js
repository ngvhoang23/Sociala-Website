...
function MediaGrid4Item({ item1, item2, item3, item4 }) {
  ...
  const renderMediaItem = (item, i, index) => {
    ...
    if (item.type === 'image') {
      return <img className={cx('four-item-media-item')} src={item.url} style={style} />;
    } else if (item.type === 'video') {
      return (
        <video
          className={cx('four-item-media-item', 'video-item')}
          controls
          muted
          style={{
            width: '100%',
  ...
  }, [item1?.url, item2?.url, item3?.url, item4?.url]);

  return (
    <div className={cx('four-item-wrapper')}>
      <div
        className={cx('four-item-container', 'item1', { flash: flashing.item === 1 })}
      ...
      <div
        className={cx('four-item-container', 'item2', { flash: flashing.item === 2 })}
      ...
      <div
        className={cx('four-item-container', 'item3', { flash: flashing.item === 3 })}
      ...
      <div
        className={cx('four-item-container', 'item4', { flash: flashing.item === 4 })}
